...
```{python}
# Ward geometry-data
wards = gpd.read_file("data/London-wards-2011/London_Ward_CityMerged.shp").to_crs(
    epsg=27700
...
plt.title(
    "Distribution of Short Term Airbnb Listings in London Boroughs(2024)", fontsize=16
)
